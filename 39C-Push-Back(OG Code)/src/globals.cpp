...
//drivetrain
pros::MotorGroup leftDrive({-1, -2, -13}, pros::MotorGears::blue);
pros::MotorGroup rightDrive({17, 18, 15}, pros::MotorGears::blue);

//Intake/Outtake motors
pros::Motor intake(19, pros::v5::MotorGears::green);
pros::Motor conveyer(8, pros::v5::MotorGears::green);
pros::Motor outtakelow(3, pros::v5::MotorGears::green);
pros::Motor outtakehigh(20, pros::v5::MotorGears::green);
...
pros::ADIDigitalOut matchload('D',true);
